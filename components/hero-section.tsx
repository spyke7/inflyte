    ...
    <>
      <main className="overflow-hidden pt-20">
        <section className="relative pt-24 md:pt-36 text-center px-6 max-w-7xl mx-auto">
          <div className="relative mx-auto flex-row w-full max-w-7xl items-center justify-center">
            ...
            <DottedGlowBackground
              className="pointer-events-none mask-radial-to-90% mask-radial-at-center opacity-85 dark:opacity-100"
              opacity={0.9}
              gap={15}
              radius={1.4}
            ...
            >
              Inflyte lets you analyze, generate charts, understand as well as
              build APIs in minutes — create, visualize requests, and monitor
          ...
          <div id="features" className="mt-20 grid gap-8 md:grid-cols-3">
            <div className="p-6 rounded-xl bg-muted/40 hover:bg-muted/60 transition">
              ...
              <p className="text-sm text-muted-foreground">
                Create and test APIs visually with our interactive workspace and
            ...
            <div className="p-6 rounded-xl bg-muted/40 hover:bg-muted/60 transition">
              ...
              <p className="text-sm text-muted-foreground">
                Get insights into structure, different objects - present in the
                API. Generate requests to different endpoints. Get graphs about
                usage, and many more.
              </p>
            </div>
            <div className="p-6 rounded-xl bg-muted/40 hover:bg-muted/60 transition">
              ...
              <p className="text-sm text-muted-foreground">
                Connect APIs seamlessly and easily. Build and test new APIs as
                well.
              </p>
            </div>
          </div>
        ...
        <section className="bg-background py-16 border-t border-border mt-20">
          <div className="flex justify-center gap-8">
            <Link
              href="https://linkedin.com/in/shreejan-dolai-29a168385"
              target="_blank"
