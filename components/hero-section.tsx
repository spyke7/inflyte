      ...
      <main className="overflow-hidden pt-20">
        <section className="relative pt-24 md:pt-36 text-center px-6 max-w-7xl mx-auto">
          <AnimatedGroup variants={transitionVariants}>
            ...
            >
              <span className="text-foreground text-sm">Introducing InFlow API Suite</span>
          ...
          >
            InFlow lets you analyze, generate charts, understand as well as build APIs in minutes — create, visualize requests, and monitor everything in one dashboard.
          </TextEffect>
